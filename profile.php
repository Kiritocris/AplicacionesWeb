    ...
    <div class="container-fluid">
		<div class="box_general padding_bottom">
			<div class="header_box version_2">
				<h2><i class="fa fa-file"></i>Mi perfil</h2>
			...
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						<label>Usuario</label>
						<?php
            echo "<input type='text' class='form-control' placeholder='$_SESSION[name]' name='userp'>";
            ?>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<input type="text" class="form-control" placeholder="**********" name="passp">
					</div>
				</div>
			</div>
		...
		<p><input class="btn_1 medium" type="submit" value="Guardar"></p>
	  </div>
	  <!-- /.container-fluid-->
   	</div>
